...
ind_year1_4 <- subset(ind_year1_4, select = c(age,Sex,DMHSize,NumAdult,NumChild,MarSt2,LiveW2,AdChild,qual7,WrkStat,NTypHrs,NCasHrs,nssec8,ethgrp5,eqv3,eqvinc,region,gor,EIMD_2015_quintile,WIMD_2014_quintile,SIMD_2016_quintile,NIMD_2017_quintile,GenHelf,StatinA,bpmedd2,Diabetes,lipid2,cigsta3,cigst2,htval,wtval,bmival,bmivg5,bmiok,omsysval,Chol,HDL,A1C,seriali,serialh,wti_1_9r))
ind_year5_6 <- subset(ind_year5_6, select = c(age,Sex,DMHSize,NumAdult,NumChild,MarSt2,LiveW2,AdChild,qual7,WrkStat,NTypHrs,NCasHrs,nssec8,ethgrp5,eqv3,eqvinc,region,gor,EIMD_2015_quintile,WIMD_2014_quintile,SIMD_2016_quintile,NIMD_2017_quintile,GenHelf,StatinA,bpmedd2,Diabetes,lipid2,cigsta3,cigst2,htval,wtval,bmival,bmivg5,bmiok,omsysval,Chol,HDL,A1C,seriali,serialh,wti_1_9r))
ind_year7_8 <- subset(ind_year7_8, select = c(age,Sex,DMHSize,NumAdult,NumChild,MarSt2,LiveW2,AdChild,qual7,WrkStat,NTypHrs,NCasHrs,nssec8,ethgrp5,eqv3,eqvinc,region,gor,EIMD_2015_quintile,WIMD_2014_quintile,SIMD_2016_quintile,NIMD_2017_quintile,GenHelf,StatinA,bpmedd2,Diabetes,lipid2,cigsta3,cigst2,htval,wtval,bmival,bmivg5,bmiok,omsysval,Chol,HDL,A1C,seriali,serialh,wti_1_9r))
ind_year9_11 <- subset(ind_year9_11, select = c(age,Sex,DMHSize,NumAdult,NumChild,MarSt2,LiveW2,AdChild,qual7,WrkStat,NTypHrs,NCasHrs,nssec8,ethgrp5,eqv3,eqvinc,region,gor,EIMD_2015_quintile,WIMD_2014_quintile,SIMD_2016_quintile,NIMD_2017_quintile,GenHelf,StatinA,bpmedd2,Diabetes,lipid2,cigsta3,cigst2,htval,wtval,bmival,bmivg5,bmiok,omsysval,Chol,HDL,A1C,seriali,serialh,wti_1_9r))
...
write.csv(NDNS, paste0("Data imputation/Data/NDNS/NDNS_combined.csv"), row.names=F)

saveRDS(NDNS, file="Data imputation/Data/NDNS/NDNS_full.RDS")
